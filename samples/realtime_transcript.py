...
rt_mgr.start_session(callback, profile=Profiles.accurate)
sock = rt_mgr.connect()

# create recorder
rec = Recorder(as_base64=True, buffer_sec=5)  # encode samples as base64, to send the chunks over web-socket
rec.start()
stop_sig = False
