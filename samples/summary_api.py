...
from sumit_sdk.summary_api import SummaryApi

api = APIClient("api-sa.json", env='dev')  # create client
summary = SummaryApi(api)

summary_type = 'short_bullets'  # or short_paragraph
...
payload = summary.build_request(summary_type=summary_type, language=language, sync=sync, content=context)
...
payload = summary.build_request(summary_type=summary_type, language=language, sync=sync, input_blob_path=filename,
